...
class ChangePasswordForm(SetPasswordForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields[
			'new_password2'].help_text = '<span class="form-text"><small>Enter the same password as before, for verification.</small></span>'
...
class SignUpForm(UserCreationForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['username'].help_text = '<span class="form-text text-muted black"><small>Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.</small></span>'
...
class UpdateUserForm(UserChangeForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['username'].label = ''
		self.fields[
			'username'].help_text = '<span class="form-text text-muted black"><small>Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.</small></span>'
