...
class Product(models.Model):
    ...
    description = models.CharField(max_length=900, default='', blank=True, null=True)
...
class UserProfile(models.Model):
    ...
    carted = models.CharField(max_length=200, blank=True, null=True)

    def __str__(self):
        return self.user.username

#automatically creating user profile once they are register
